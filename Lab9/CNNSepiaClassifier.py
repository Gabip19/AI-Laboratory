...
class CNNSepiaClassifier(AbstractClassifier):
    ...
    def train_classifier(self, train_inputs, train_outputs):
        ...
        classifier.fit(train_inputs, train_outputs, epochs=40, batch_size=32)
    ...
    def run_classifier(self, train_inputs, train_outputs, test_inputs, test_outputs):
        ...
        print("Recall: ", recall)
        plot_confusion_matrix(conf_matrix, output_names, "Sepia CNN classification")
